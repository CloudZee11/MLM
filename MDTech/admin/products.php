...
class ProductHandler
{
    ...
    public function addProduct($productName, $brand, $consumption, $type, $price, $color, $description, $features, $imageFullPath)
    {
        ...
        $sql = "INSERT INTO airconditioners (name, brand, consumption, type, price, color, description, features, image) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$productHandler->addProduct($productName, $brand, $consumption, $type, $price, $color, $description, $features, $imageFullPath);
